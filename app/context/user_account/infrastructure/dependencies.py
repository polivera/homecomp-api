...
def get_update_account_handler(
    ...
    return UpdateAccountHandler(service)
...
def get_delete_account_handler(
    ...
    return DeleteAccountHandler(repository)
...
def get_find_account_by_id_handler(
    ...
    return FindAccountByIdHandler(repository)
...
def get_find_accounts_by_user_handler(
    ...
    return FindAccountsByUserHandler(repository)
